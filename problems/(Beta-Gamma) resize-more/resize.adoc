= Resize (for those more comfortable)
...
Be sure you're familiar with the structure of 24-bit uncompressed BMPs, as introduced in [Whodunit](/problems/beta-gamma-whodunit).
...
[source]
----
check50 uva/progki/2018/resize/more
----
