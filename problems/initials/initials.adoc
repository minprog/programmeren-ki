...
== More comfortable
If you yourself are more comfortable with the material, maybe because you already have some programming experience or you just like to challenge yourself a bit more, then this is the assigment for you [initials (more comfortable)](/problems/initials-more).

Otherwise implement initials as specified below.
...
[source]
----
check50 uva/progki/2018/initials/less
----
