...
* Write, in a file called `mario.c` in your `~/pset1/mario/more/` directory, a program that recreates these half-pyramids using hashes (`#`) for blocks.
...
[source]
----
check50 minprog/cs50x/2019/mario/more
----
